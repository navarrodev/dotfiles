...
if &t_Co >= 256 || has("gui_running")
    ...
    hi PreProc ctermbg=100 ctermfg=254 cterm=NONE guibg=bg guifg=#e4e4e4 gui=NONE
    ...
    hi String ctermbg=bg ctermfg=110 cterm=NONE guibg=#262626 guifg=#87afd7 gui=NONE
